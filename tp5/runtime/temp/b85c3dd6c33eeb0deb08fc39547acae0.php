	...
	<!-- /Sidebar Menu -->
			...
			<div class="page-content">
				...
				<div class="page-body">
					...
					<button type="button" tooltip="添加栏目"
						class="btn btn-sm btn-azure btn-addon"
						onClick="javascript:window.location.href = '<?php echo url('cate/add'); ?>'">
										...
										<table class="table table-bordered table-hover">
											...
											<?php foreach($list as $vo): ?>
												<tr>
													...
													<td align="center"><a
														href="<?php echo url('cate/edit',array('id'=>$vo['id'])); ?>"
														class="btn btn-primary btn-sm shiny"> <i
															class="fa fa-edit"></i> 编辑
													</a> <a href="#"
														onClick="warning('确实要删除吗', '<?php echo url('cate/delete',array('id'=>$vo['id'])); ?>')"
